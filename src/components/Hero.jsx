...
const Hero = () => {
    return (
        <>
        <section className="bg-white h-96 py-8 max-w-5xl">
            <div className="container flex flex-row max-w-5xl">
                ...
                <div className="basis-1/2 pl-20">
                    <img src="/assets/heroimage.png" alt="" className={'w-11/12 h-11/12 right-6'}/>
                </div>
            </div>
        </section>
        </>
