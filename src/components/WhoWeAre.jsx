...
const WhoWeAre = () => {
    ...
    return(
        ...
        <section className="container bg-white flex flex-row w-full h-96">
            <div className="basis-1/2 py-8 px-8 w-full h-fit">
                <img src="/assets/quemsomos.png" className="w-12/12 h-12/12"></img>
            </div>
            <div className="flex flex-col basis-1/2 content-start items-start py-8 px-8 w-full h-full">
                <h2 className="text-3xl font-semibold mb-2">Quem Somos</h2>
                <h3 className="text-1xl font-normal mb-3">LOREM IPSUM</h3>
                <a className="text-md font-light mb-5">
