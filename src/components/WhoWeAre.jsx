    ...
    return(
        ...
        <section className="container bg-white flex flex-row w-full h-96 max-w-screen-2xl xl:h-[550px]">
            <div className="basis-1/2 py-4 px-8 w-full h-96 xl:h-[550px] xl:py-0">
                <img src="/assets/quemsomos.png" className="w-10/12 h-10/12 max-h-screen-2xl"></img>
            </div>
            <div className="flex flex-col basis-1/2 content-start items-start py-8 px-8 w-full h-96 xl:h-[550px] xl:py-20">
                <h2 className="text-3xl font-semibold mb-2 xl:text-5xl">Quem Somos</h2>
                <h3 className="text-1xl font-normal mb-2 xl:text-3xl xl:mb-6">LOREM IPSUM</h3>
                <a className="text-sm font-light mb-4 xl:text-xl xl:mb-8">
