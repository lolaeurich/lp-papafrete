            ...
            <div className="flex h-full w-full">
                <div className="flex basis-1/3 flex-col pt-8 mt-4 justify-around">
                    <div className="flex flex-row justify-center">
                        <h2 className="font-bold">Sobre a PAPA FRETE</h2>
                    </div>
                    <div className="flex flex-col justify-center">
                        <ul className="flex-col pl-28 list-disc">
                ...
                <div className="flex flex-col basis-1/3 pt-8 mt-4 px-8 justify-center content-center">
                    <div className="flex justify-around mb-4">
                        <img src="/assets/icon1.png" alt="" className="h-8 w-8"></img>
                        <img src="/assets/icon1.png" alt="" className="h-8 w-8"></img>
                        <img src="/assets/icon1.png" alt="" className="h-8 w-8"></img>
                        <img src="/assets/icon1.png" alt="" className="h-8 w-8"></img>
                    </div>
                ...
                <div className="flex flex-col basis-1/3 pt-8 mt-4 px-8 justify-center content-center">
                    <div className="flex flex-col justify-start">
                        <h3 className="text-l font-semibold mb-4">Assine nossa newsletter</h3>
                        <form className="">
